...
import { APP_ROUTES, useAppSelector, useAppDispatch, orangeLoadingImg } from '@shared';
        ...
        if (user.tryToFetch) {
            return (
                <div className={styles.waiting}>
                    ...
                    <img className={styles.waiting_image} src={orangeLoadingImg} alt="waiting spinner" />
                </div>
            );
        } else {
            return (
